...
// through two older lower highs can already run below the price, and on
// SOL 45211 the line re-anchored after the activation would have sold at
// ~179.4 hours before the one permitted depth filled at 175.83. The band leg
// stands on its own; with no line served it is the only target.
