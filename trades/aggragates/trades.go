...
type (
	Trades struct {
		...
		Settings        SettingsPairs   `gorm:"foreignKey:idx_symbol;references:StrategyID"  form:"settings" json:"settings" xml:"settings"`
		...
		History         []TradesHistory `gorm:"foreignKey:TradeID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" bson:"history" json:"history"`
		Logs            []TradesLogs    `gorm:"foreignKey:TradeID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" bson:"logs" json:"logs"`
